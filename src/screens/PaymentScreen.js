                ...
                <Card>
                    <ListGroup variant="flush">
                        ...
                        <Col style={{ color: "black" }}>
                            <p className="name" style={{ color: "black" }}>{props.address.name},</p>
                            ...
                            {props.address.state ? <p>{props.address.state}, India,{props.address.mobile}</p> : <p>India,{props.address.mobile}</p>}
                        </Col>
                        <Link to="/lastScreen">
                            <Button type="button" className="btn-block" onclick={confirmPayment}>
                                Confirm Payment
                            </Button>
                        </Link>
                    </ListGroup>
...
const mapStateToProps = (state) => {
    console.log("Inside", state.BookReducer.address);
    return {
...
const mapDispatchToProps = (dispatch) => {
    return {
        OnconfirmPayment: (cartItems, address) => dispatch(actions.OnconfirmPaymentAction(cartItems, address)),
